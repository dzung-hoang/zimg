...
{
	return !(csp.matrix == MatrixCoefficients::REC_2100_ICTCP && csp.transfer != TransferCharacteristics::ST_2084 &&
		 csp.transfer != TransferCharacteristics::ARIB_B67) &&
	       !(csp.matrix == MatrixCoefficients::REC_2100_LMS && csp.transfer != TransferCharacteristics::LINEAR &&
		 csp.transfer != TransferCharacteristics::ST_2084 && csp.transfer != TransferCharacteristics::ARIB_B67) &&
	       !(csp.matrix == MatrixCoefficients::REC_2100_LMS && csp.primaries != ColorPrimaries::REC_2020) &&
	       !(csp.matrix == MatrixCoefficients::REC_2100_ICTCP && csp.primaries != ColorPrimaries::REC_2020) &&
	       !(csp.matrix == MatrixCoefficients::REC_2020_CL && csp.transfer != TransferCharacteristics::REC_709) &&
...
std::vector<ColorspaceNode> get_neighboring_colorspaces(const ColorspaceDefinition &csp)
{
	...
	} else if (csp.matrix == MatrixCoefficients::REC_2100_LMS && csp.primaries == ColorPrimaries::REC_2020) {
	...
	} else if (csp.matrix == MatrixCoefficients::REC_2100_ICTCP && csp.primaries == ColorPrimaries::REC_2020) {
